...
export default function SellerDashboard() {
  ...
  const isReadyToAcceptPayments = true;// accountStatus?.isActive && accountStatus?.payoutsEnabled;
      ...
      <div className="bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        {/* ----------------------OR(START)------------ */}
         ...
         {/* <div className="flex items-center justify-center my-4">
          ...
          <span className="mx-4 text-blue-800">OR</span>
          <div className="flex-grow border-t border-gray-300"></div>
        </div>   */}
        ...
        <div className="mt-0">
          ...
          {/* <div className="flex items-center p-4 mb-4 text-sm text-yellow-800 border border-yellow-300 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-300 dark:border-yellow-800" role="alert">
            ...
            <div>
              <span className="font-bold">Warning:</span> Stripe is currently not working for payments in India.
            </div>
          </div> */}
