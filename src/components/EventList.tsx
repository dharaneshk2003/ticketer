...
function EventList() {
  ...
  return (
    <div>
      ...
      {/* Upcoming Event Grids */}
      {upcomingEvents.length > 0 ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12 ml-2">
      ...
      {pastEvents.length > 0 && (
        <>
        <h2 className="text-2xl font-bold text-gray-900 mb-6 ml-3">Past Events</h2>
